    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId()){
            case R.id.nav_message_id:
                ...
                //Intent intent = new Intent(this, Mis_sitios.class);
                //startActivity(intent);
                //Intent btnNumero = new Intent(MainActivity.this, Mis_sitios.class);
            ...
            case R.id.nav_chat_id:
                ...
                Intent btnNumero = new Intent(MainActivity.this, Ubicacion.class);
                startActivity(btnNumero);
                closeDrawer();
                break;
